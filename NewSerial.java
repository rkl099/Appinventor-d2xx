...
//import com.physicaloid.j2xx.D2xxManager;         // For combined d2xx library
import com.ftdi.j2xx.D2xxManager;                //For added d2xx library
import com.ftdi.j2xx.*;                          //For added d2xx library
...
@UsesLibraries(libraries = "physicaloid.jar,"+"d2xx.jar" )  //For added d2xx library
//@UsesLibraries(libraries = "physicaloid.jar" )            ////For combined d2xx library

public class NewSerial extends AndroidNonvisibleComponent implements Component {
  ...
  public NewSerial(ComponentContainer container) {
  ...
  public boolean OpenSerial() {
    ...
    if (mPhysicaloid == null) {
      form.dispatchErrorOccurredEvent(NewSerial.this, "OpenSerial", ErrorMessages.ERROR_SERIAL_NOT_INITIALIZED);
      return false;
    }
  ...
  public boolean CloseSerial() {
    ...
    if (mPhysicaloid == null) {
      form.dispatchErrorOccurredEvent(NewSerial.this, "CloseSerial", ErrorMessages.ERROR_SERIAL_NOT_INITIALIZED);
      return false;
    }
  ...
  public String ReadSerial() {
    String data = "";
    if (mPhysicaloid == null) {
      form.dispatchErrorOccurredEvent(NewSerial.this, "ReadSerial", ErrorMessages.ERROR_SERIAL_NOT_INITIALIZED);
    } else {
  ...
  public void WriteSerial(String data) {
    if (!data.isEmpty() && mPhysicaloid != null) {
      ...
      if (result == -1)
        form.dispatchErrorOccurredEvent(NewSerial.this, "WriteSerial", ErrorMessages.ERROR_SERIAL_WRITING);
    } else if (mPhysicaloid == null) {
      form.dispatchErrorOccurredEvent(NewSerial.this, "WriteSerial", ErrorMessages.ERROR_SERIAL_NOT_INITIALIZED);
    }
  }
  ...
  public boolean IsOpen() {
    if (mPhysicaloid == null) {
      form.dispatchErrorOccurredEvent(NewSerial.this, "IsOpen", ErrorMessages.ERROR_SERIAL_NOT_INITIALIZED);
      return false;
    }
